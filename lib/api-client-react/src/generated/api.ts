...
export const getListCodesQueryKey = (params?: ListCodesParams) => {
  return [`/api/codes`, ...(params ? [params] : [])] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listCodes>>> = ({
    signal,
  }) => listCodes(params, { signal, ...requestOptions });
...
export const mapCode = async (
  id: number,
  mapCodeBody: MapCodeBody,
  options?: RequestInit,
): Promise<Code> => {
  return customFetch<Code>(getMapCodeUrl(id), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(mapCodeBody),
  });
};

export const getMapCodeMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type MapCodeMutationResult = NonNullable<
  Awaited<ReturnType<typeof mapCode>>
>;
...
export const getGetProductReportUrl = (params?: GetProductReportParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/reports/product?${stringifiedParams}`
    : `/api/reports/product`;
};
...
export const getGetProductReportQueryKey = (
  ...
  return [`/api/reports/product`, ...(params ? [params] : [])] as const;
};
...
export const getGetShipperSummaryUrl = (params?: GetShipperSummaryParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/reports/shipper-summary?${stringifiedParams}`
    : `/api/reports/shipper-summary`;
};

export const getShipperSummary = async (
  params?: GetShipperSummaryParams,
  options?: RequestInit,
): Promise<ShipperSummaryRow[]> => {
...
export const getGetShipperSummaryQueryKey = (
  params?: GetShipperSummaryParams,
) => {
  return [`/api/reports/shipper-summary`, ...(params ? [params] : [])] as const;
};

export const getGetShipperSummaryQueryOptions = <
  TData = Awaited<ReturnType<typeof getShipperSummary>>,
  TError = ErrorType<unknown>,
>(
  params?: GetShipperSummaryParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getShipperSummary>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetShipperSummaryQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getShipperSummary>>
  > = ({ signal }) => getShipperSummary(params, { signal, ...requestOptions });
...
export type GetShipperSummaryQueryResult = NonNullable<
  Awaited<ReturnType<typeof getShipperSummary>>
>;
export type GetShipperSummaryQueryError = ErrorType<unknown>;

export function useGetShipperSummary<
  TData = Awaited<ReturnType<typeof getShipperSummary>>,
  TError = ErrorType<unknown>,
>(
  params?: GetShipperSummaryParams,
...
export const getGetPalletSummaryUrl = (params?: GetPalletSummaryParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/reports/pallet-summary?${stringifiedParams}`
    : `/api/reports/pallet-summary`;
};

export const getPalletSummary = async (
  params?: GetPalletSummaryParams,
  options?: RequestInit,
): Promise<PalletSummaryRow[]> => {
...
export const getGetPalletSummaryQueryKey = (
  params?: GetPalletSummaryParams,
) => {
  return [`/api/reports/pallet-summary`, ...(params ? [params] : [])] as const;
};

export const getGetPalletSummaryQueryOptions = <
  TData = Awaited<ReturnType<typeof getPalletSummary>>,
  TError = ErrorType<unknown>,
>(
  params?: GetPalletSummaryParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getPalletSummary>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetPalletSummaryQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getPalletSummary>>
  > = ({ signal }) => getPalletSummary(params, { signal, ...requestOptions });
...
export type GetPalletSummaryQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPalletSummary>>
>;
export type GetPalletSummaryQueryError = ErrorType<unknown>;

export function useGetPalletSummary<
  TData = Awaited<ReturnType<typeof getPalletSummary>>,
  TError = ErrorType<unknown>,
>(
  params?: GetPalletSummaryParams,
...
export const getMarkedByLog = async (
  options?: RequestInit,
): Promise<MarkedByEntry[]> => {
...
export const getGetMarkedByLogQueryKey = () => {
  return [`/api/reports/marked-by`] as const;
};

export const getGetMarkedByLogQueryOptions = <
  TData = Awaited<ReturnType<typeof getMarkedByLog>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getMarkedByLog>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getMarkedByLog>>> = ({
    signal,
  }) => getMarkedByLog({ signal, ...requestOptions });
...
export type GetMarkedByLogQueryResult = NonNullable<
  Awaited<ReturnType<typeof getMarkedByLog>>
>;
export type GetMarkedByLogQueryError = ErrorType<unknown>;

export function useGetMarkedByLog<
  TData = Awaited<ReturnType<typeof getMarkedByLog>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
