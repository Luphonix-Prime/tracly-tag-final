              ...
              >
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-x-3 gap-y-1 w-full text-[9px] font-mono">
                    <div>Super Master: <code className="bg-slate-200 dark:bg-slate-900 px-1 rounded text-slate-800 dark:text-white font-medium">supermaster</code> / <code className="bg-slate-200 dark:bg-slate-900 px-1 rounded text-slate-600 dark:text-slate-300">super123</code></div>
